---
title: Chakra UI Heading - Horizon UI
...
The `Heading` composes the [Box](/docs-horizon-ui-chakra/docs/layout/box)
component, so you can pass all `Box` props.

<PropsTable of="Heading" omit={null} />
