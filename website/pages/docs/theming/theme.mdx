---
title: Chakra UI Theme (Colors, etc) - Horizon UI
description: The default Horizon UI theme tokens
---

The theme object is where you define your Horizon UI's color palette, type
...
> Learn more about
> [Responsive Styles and Customizing Breakpoints](/docs-horizon-ui-chakra/docs/features/responsive-styles).
