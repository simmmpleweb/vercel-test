---
title: Chakra UI Breadcrumb - Horizon UI
...
Breadcrumb composes [Box](/docs-horizon-ui-chakra/docs/layout/box) so you can
...
The BreadcrumbLink composes the [Link](/docs-horizon-ui-chakra/link) component
so you can use all Link props.

<PropsTable of="BreadcrumbLink" />

### BreadcrumbSeparator Props

The BreadcrumbSeparator composes the
[Box](/docs-horizon-ui-chakra/docs/layout/box) component so you can use all Box
props.
