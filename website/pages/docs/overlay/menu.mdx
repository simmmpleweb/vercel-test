...
`MenuButton` composes [Box](/docs-horizon-ui-chakra/docs/layout/box) so you can
pass all `Box` props to change its style.

### MenuList Props

`MenuList` composes [Box](/docs-horizon-ui-chakra/docs/layout/box) so you can
pass all `Box` props to change its style.
...
`MenuGroup` composes [Box](/docs-horizon-ui-chakra/docs/layout/box) so you can
pass all `Box` props to change its style.
...
`MenuItemOption` composes [Box](/docs-horizon-ui-chakra/docs/layout/box) so you
